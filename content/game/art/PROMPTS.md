...
| Person (`npc_*`) | 1:1 | Brustbild, frontal, Blick zum Betrachter, Kopf im oberen Drittel |
...
cups behind the counter, warm lamps hanging low over the tables. Empty of people, one cup left on a
table.
```
...
right wall, a beer tap, low warm lamps and deep shadows in the corners. Empty of people, one glass
...
```
Portrait of a Russian man in his late sixties in a village bar: weathered friendly face, deep
forehead lines, thick grey moustache and bushy grey eyebrows, thinning grey hair under a dark flat
cap, worn brown jacket over a light shirt. Calm, curious expression, as if he has just asked a
question. Blurred bar counter and bottles behind him.
```

### `npc_nadja` — Nadja, Bar (die Wirtin)

```
Portrait of a Russian woman in her forties behind a bar counter: auburn hair pulled back into a
tight bun, gold hoop earrings, teal blouse under a light apron, alert eyes and a short friendly
half-smile, arms about to reach for a glass. Blurred shelf of glasses and bottles behind her.
```

### `npc_sasha` — Sascha, Bar (jung, redet schnell)

```
Portrait of a Russian man in his early twenties in a village bar: messy dark hair, wide open eyes,
raised eyebrows, mouth open mid-sentence, blue hoodie with the strings hanging loose, leaning
slightly towards the viewer. Energetic and talkative. Blurred bar interior behind him.
```

### `npc_oleg` — Oleg, Bar (wortkarg)

```
Portrait of a broad-shouldered Russian man in his fifties in a village bar: square face, full dark
beard, narrow eyes under heavy brows, dark red knitted beanie, olive work jacket over a grey
sweater. Silent, unbothered expression, mouth a straight line. Blurred bar interior behind him.
```

### `npc_vera` — Vera, Bar (fragt nach der Familie)

```
Portrait of a Russian woman in her sixties in a village bar: round glasses, warm laugh lines, a blue
patterned headscarf tied under the chin, dark red floral blouse. Leaning in with a broad, genuinely
interested smile, as if about to ask about your family. Blurred bar interior behind her.
```

### `npc_lena` — Lena, Café (Kellnerin)

```
Portrait of a Russian woman in her thirties in a village cafe: dark blonde hair in a ponytail, white
shirt with a black apron, small notepad in one hand, patient attentive smile, head slightly tilted.
Blurred cafe counter with a coffee machine behind her.
```
